...
<body>
	...
	<table style="line-height: 1.5em;width: 100%;">
		<tr>
			<td align="center">
				...
				<span style="line-height: 1.6; font-weight: bold;">
					<font size="3"> <br>Jl. Otto Iskandardinata NO.64C, Jakarta 13330
	...
	<p style="line-height:20px; text-align:center">
		<font size="5" face="Arial"><b><u>SURAT KETERANGAN</u></b></font><br>
	...
	<div class="container">
		...
		<br>
		<table width="680" style="margin-left: 50px;line-height: 1.5em;font-family:Calibri, 'Trebuchet MS', sans-serif">
			<tr class="text2" style="font-size :12ch">
				<td>Nama</td>
				<td width="541" style="text-transform: uppercase;"> : <?= $pengajuanDetail['nama'] ?>
				</td>
			</tr>
			<tr style="font-size :12ch">
				<td>Kelas</td>
				<td width="525" style="text-transform: uppercase;"> : <?= $pengajuanDetail['kelas'] ?></td>
			</tr>
			<tr style="font-size :12ch">
				<td>NIM</td>
				<td width="525" style="text-transform: uppercase;"> : <?= $pengajuanDetail['nim'] ?></td>
			</tr>
			<tr style="font-size :12ch">
				<td>Tempat/Tanggal Lahir</td>
				<td width="525" style="text-transform: uppercase;"> : <?= $pengajuanDetail['tempattanggallahir'] ?></td>
			</tr>
			<tr style="font-size :12ch">
				<td>Status</td>
				<td width="525" style="text-transform: uppercase;"> : <?= $pengajuanDetail['status'] ?></td>
			</tr>
			<br>
		</table>
		<table width="100%" style="text-align: justify; line-height: 1.5em;font-family:Calibri, 'Trebuchet MS', sans-serif ">
			<tr>
				<td>
					<font>adalah benar-benar mahasiswa Program Studi <?= $pengajuanDetail['prodi'] ?> Program Diploma <?= $pengajuanDetail['diploma'] ?> Politeknik Statistika STIS Jakarta Semester <?= $pengajuanDetail['semester'] ?> Tahun Akademik <?= $pengajuanDetail['tahunakademik'] ?>. Surat keterangan ini dibuat untuk kepentingan <?= $pengajuanDetail['kategori'] ?> (<?= $pengajuanDetail['tujuan'] ?>).

						<p>Demikian surat ini diberikan agar dapat digunakan sebagaimana mestinya.
						</p>
					</font>
				</td>
			</tr>
	...
	<table width="625" style="line-height: 1.5em;font-family:Calibri, 'Trebuchet MS', sans-serif">
		<tr>
			...
			<?php $M = "januari"; ?>
			<td class="text" align="center">Jakarta, <?= date('j F Y', strtotime($pengajuanDetail['tanggalacckbaak'])); ?><br><br>
				Politeknik Statistika STIS,
				<br>
				Kepala Bagian Administrasi <br> Akademik dan Kemahasiswaan,
				<br><br><br><br><br><br>Nurseto Wisnumurti
			</td>
		</tr>
