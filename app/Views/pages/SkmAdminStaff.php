...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="HomeAdminStaff.html">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="SkmAdminStaff.html" data-toggle="collapse" data-target="#collapseTwo"
        ...
        <div class="modal-body">
            <form class="row g-3">
              <div class="col-md-12">
                ...
                <input class="form-control" type="text" placeholder="id Dokumen" aria-label="Disabled input example" disabled>
              </div>
              <div class="col-md-12">
                <label for="namaMhsw" class="form-label">Nama Mahasiswa</label>
                <input class="form-control" type="text" placeholder="Nama Mahasiswa" aria-label="Disabled input example" disabled>
              </div>
              <div class="col-md-12">
        ...
        <div class="modal-body">
            <form class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" type="text" placeholder="Administrasi Orangtua" aria-label="Disabled input example" disabled>
              </div>
              <div class="col-md-12">
                <label for="Tujuan" class="form-label">Tujuan</label>
                <input class="form-control" type="text" placeholder="Persyaratan Taspen" aria-label="Disabled input example" disabled>
              </div>
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                ...
                <textarea class="form-control" id="alasan" rows="3" placeholder="Tidak memenuhi persyaratan" aria-label="Disabled input example" disabled></textarea>
              </div>
            </form>
          </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" >
        ...
        <div class="modal-footer" >
            ...
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#teruskanStaffModal2" data-dismiss="modal">Teruskan</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" >
        ...
        <div class="modal-footer" >
            ...
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#tangguhStaffModal2" data-dismiss="modal">Tangguhkan</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" >
        ...
        <div class="modal-footer" >
            ...
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#tangguhStaffModal2">Tolak</button>
