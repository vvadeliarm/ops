    ...
    <div id="content-wrapper" class="d-flex flex-column" style="background-color: #151965">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 style="color: white">Hallo, Staff BAAK!</h1>
          <p style="color: white"><br />Bagaimana Kabar Hari ini ? <br />Semangat!!</p>
          <br />
...
>>>>>>> db69a8bfdf5fb7e189cb3941c09703e9262b7ffa
                <h2 class="m-0 font-weight-bold text-primary " >BAAK</h2>
                <br>  <h3 class="m-0 font-weight-bold text-primary" >Politeknik Statistika STIS</h3>
            </div>
            -->
<<<<<<< HEAD
              <!-- Brand Buttons -->
              <div class="card shadow mb-4" style="background-color: #151965">
                <div class="card-body" style="color: white">
                  <h2 class="m-0 font-weight-bold text-primary">BAAK</h2>
                  <br />
                  <h3 class="m-0 font-weight-bold text-primary">Politeknik Statistika STIS</h3>
                </div>

                <div class="card-body" style="color: white">
                  <p>
                    Salah satu unsur pelaksana administrasi Bagian Administrasi Akademik dan Kemahasiswaan (BAAK) . Pejabat struktural unsur pelaksana administrasi diangkat dan diberhentikan oleh Kepala BPS RI atas usulan Direktur
                    Politeknik Statistika STIS. BAAK bertugas melaksanakan pengelolaan administrasi akademik dan kemahasiswaan.
                  </p>
                </div>
              </div>
            </div>
