            ...
            <div class="col">
                ...
                <form class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" placeholder="Tanggal Lahir mahasiswa" aria-label="Disabled input example" disabled>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control" type="text" placeholder="NIM mahasiswa" aria-label="Disabled input example" disabled>
                    </div>
                    <div class="col-md-3">
                        <label for="inputKelas" class="form-label">Kelas</label>
                        <input class="form-control" type="text" placeholder="Kelas mahasiswa" aria-label="Disabled input example" disabled>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" placeholder="Program Studi mahasiswa" aria-label="Disabled input example" disabled>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-12">
                        <a href="/pages/layananSKM"><button class="btn btn-primary" type="button">Ajukan SKM</button></a>
                    </div>
                </form>
                <!-- Akhir Form-->
