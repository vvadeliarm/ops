            ...
            <div class="row text-center mb-5">
                <div class="col">
                    ...
                    <form form action="/CRUDPengajuan/simpanPengajuan" method="POST" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-md-6" style="text-align: left;font-weight: bold">
                            <label for="formFile" class="form-label">Unggah file pendukung (max 300kb) </label>
                        ...
                        <div class="col-md-7" style="text-align: left;font-weight: bold">
                    ...
                    <!-- Footer -->
                    <div>
                        <footer class="sticky-footer" style="background-color:#F5F5F5;">
